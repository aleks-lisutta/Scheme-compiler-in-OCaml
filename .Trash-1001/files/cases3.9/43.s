...
mov rax, qword const_tbl+167
push rax

mov rax, qword const_tbl+143
push rax

mov rax, qword const_tbl+119
push rax

mov rax, qword const_tbl+100
push rax

mov rax, qword const_tbl+79
push rax
...
push 6
            ...
            MAKE_CLOSURE(rax,rax,code58)        
            jmp end_code58               ;; lambda
...
loop_in58:                              ;;lambda
    ...
    loop_args58:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args58 ;;lambda

only_n_env_ret_rbp58:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code59)        
            jmp end_code59               ;; lambda
...
loop_in59:                              ;;lambda
    ...
    loop_args59:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args59 ;;lambda

only_n_env_ret_rbp59:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code60)        
            jmp end_code60               ;; lambda
...
loop_in60:                              ;;lambda
    ...
    loop_args60:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args60 ;;lambda

only_n_env_ret_rbp60:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code61)        
            jmp end_code61               ;; lambda
...
loop_in61:                              ;;lambda
    ...
    loop_args61:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args61 ;;lambda

only_n_env_ret_rbp61:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code62)        
            jmp end_code62               ;; lambda
...
loop_in62:                              ;;lambda
    ...
    loop_args62:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args62 ;;lambda

only_n_env_ret_rbp62:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code63)        
            jmp end_code63               ;; lambda
...
loop_in63:                              ;;lambda
    ...
    loop_args63:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args63 ;;lambda

only_n_env_ret_rbp63:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code65)        
            jmp end_code65               ;; lambda
...
loop_in65:                              ;;lambda
    ...
    loop_args65:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args65 ;;lambda

only_n_env_ret_rbp65:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code66)        
            jmp end_code66               ;; lambda
...
loop_in66:                              ;;lambda
    ...
    loop_args66:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args66 ;;lambda

only_n_env_ret_rbp66:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code67)        
            jmp end_code67               ;; lambda
...
loop_in67:                              ;;lambda
    ...
    loop_args67:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args67 ;;lambda

only_n_env_ret_rbp67:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code68)        
            jmp end_code68               ;; lambda
...
loop_in68:                              ;;lambda
    ...
    loop_args68:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args68 ;;lambda

only_n_env_ret_rbp68:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code70)        
            jmp end_code70               ;; lambda
...
loop_in70:                              ;;lambda
    ...
    loop_args70:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args70 ;;lambda

only_n_env_ret_rbp70:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code71)        
            jmp end_code71               ;; lambda
...
loop_in71:                              ;;lambda
    ...
    loop_args71:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args71 ;;lambda

only_n_env_ret_rbp71:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code72)        
            jmp end_code72               ;; lambda
...
loop_in72:                              ;;lambda
    ...
    loop_args72:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args72 ;;lambda

only_n_env_ret_rbp72:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code73)        
            jmp end_code73               ;; lambda
...
loop_in73:                              ;;lambda
    ...
    loop_args73:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args73 ;;lambda

only_n_env_ret_rbp73:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code74)        
            jmp end_code74               ;; lambda
...
loop_in74:                              ;;lambda
    ...
    loop_args74:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args74 ;;lambda

only_n_env_ret_rbp74:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code75)        
            jmp end_code75               ;; lambda
...
loop_in75:                              ;;lambda
    ...
    loop_args75:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args75 ;;lambda

only_n_env_ret_rbp75:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code76)        
            jmp end_code76               ;; lambda
...
loop_in76:                              ;;lambda
    ...
    loop_args76:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args76 ;;lambda

only_n_env_ret_rbp76:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code77)        
            jmp end_code77               ;; lambda
...
loop_in77:                              ;;lambda
    ...
    loop_args77:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args77 ;;lambda

only_n_env_ret_rbp77:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
