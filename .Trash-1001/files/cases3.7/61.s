...
MAKE_LITERAL_SYMBOL(85)
MAKE_LITERAL_STRING "had"
MAKE_LITERAL_SYMBOL(107)
MAKE_LITERAL_STRING "a"
MAKE_LITERAL_SYMBOL(128)
MAKE_LITERAL_STRING "little"
MAKE_LITERAL_SYMBOL(147)
MAKE_LITERAL_STRING "lambda"
MAKE_LITERAL_SYMBOL(171)
...
mov rax, qword const_tbl+186
push rax

mov rax, qword const_tbl+162
push rax

mov rax, qword const_tbl+138
push rax

mov rax, qword const_tbl+119
push rax

mov rax, qword const_tbl+98
push rax
...
push 6
            ...
            MAKE_CLOSURE(rax,rax,code101)        
            jmp end_code101               ;; lambda
...
loop_in101:                              ;;lambda
    ...
    loop_args101:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args101 ;;lambda

only_n_env_ret_rbp101:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code102)        
            jmp end_code102               ;; lambda
...
loop_in102:                              ;;lambda
    ...
    loop_args102:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args102 ;;lambda

only_n_env_ret_rbp102:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code103)        
            jmp end_code103               ;; lambda
...
loop_in103:                              ;;lambda
    ...
    loop_args103:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args103 ;;lambda

only_n_env_ret_rbp103:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code104)        
            jmp end_code104               ;; lambda
...
loop_in104:                              ;;lambda
    ...
    loop_args104:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args104 ;;lambda

only_n_env_ret_rbp104:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code105)        
            jmp end_code105               ;; lambda
...
loop_in105:                              ;;lambda
    ...
    loop_args105:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args105 ;;lambda

only_n_env_ret_rbp105:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code106)        
            jmp end_code106               ;; lambda
...
loop_in106:                              ;;lambda
    ...
    loop_args106:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args106 ;;lambda

only_n_env_ret_rbp106:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code107)        
            jmp end_code107               ;; lambda
...
loop_in107:                              ;;lambda
    ...
    loop_args107:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args107 ;;lambda

only_n_env_ret_rbp107:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code108)        
            jmp end_code108               ;; lambda
...
loop_in108:                              ;;lambda
    ...
    loop_args108:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args108 ;;lambda

only_n_env_ret_rbp108:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code109)        
            jmp end_code109               ;; lambda
...
loop_in109:                              ;;lambda
    ...
    loop_args109:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args109 ;;lambda

only_n_env_ret_rbp109:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code110)        
            jmp end_code110               ;; lambda
...
loop_in110:                              ;;lambda
    ...
    loop_args110:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args110 ;;lambda

only_n_env_ret_rbp110:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code111)        
            jmp end_code111               ;; lambda
...
loop_in111:                              ;;lambda
    ...
    loop_args111:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args111 ;;lambda

only_n_env_ret_rbp111:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code112)        
            jmp end_code112               ;; lambda
...
loop_in112:                              ;;lambda
    ...
    loop_args112:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args112 ;;lambda

only_n_env_ret_rbp112:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code113)        
            jmp end_code113               ;; lambda
...
loop_in113:                              ;;lambda
    ...
    loop_args113:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args113 ;;lambda

only_n_env_ret_rbp113:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code114)        
            jmp end_code114               ;; lambda
...
loop_in114:                              ;;lambda
    ...
    loop_args114:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args114 ;;lambda

only_n_env_ret_rbp114:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code115)        
            jmp end_code115               ;; lambda
...
loop_in115:                              ;;lambda
    ...
    loop_args115:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args115 ;;lambda

only_n_env_ret_rbp115:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code116)        
            jmp end_code116               ;; lambda
...
loop_in116:                              ;;lambda
    ...
    loop_args116:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args116 ;;lambda

only_n_env_ret_rbp116:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code117)        
            jmp end_code117               ;; lambda
...
loop_in117:                              ;;lambda
    ...
    loop_args117:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args117 ;;lambda

only_n_env_ret_rbp117:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code118)        
            jmp end_code118               ;; lambda
...
loop_in118:                              ;;lambda
    ...
    loop_args118:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args118 ;;lambda

only_n_env_ret_rbp118:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code119)        
            jmp end_code119               ;; lambda
...
loop_in119:                              ;;lambda
    ...
    loop_args119:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args119 ;;lambda

only_n_env_ret_rbp119:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
...
push 2
            ...
            MAKE_CLOSURE(rax,rax,code120)        
            jmp end_code120               ;; lambda
...
loop_in120:                              ;;lambda
    ...
    loop_args120:             ;;lambda
            ...
            mov qword [r11],r10   
            cmp rcx,0
            jne loop_args120 ;;lambda

only_n_env_ret_rbp120:
            lea rax, [rbp+WORD_SIZE*(3+rdx)]
            mov r12, 0+2
            mov qword [rax],r12              ;;len
