...
mov rax, qword const_tbl+442
push rax

mov rax, qword const_tbl+425
push rax

mov rax, qword const_tbl+408
push rax

mov rax, qword const_tbl+391
push rax

mov rax, qword const_tbl+374
push rax

mov rax, qword const_tbl+357
push rax

mov rax, qword const_tbl+340
push rax

mov rax, qword const_tbl+323
push rax

mov rax, qword const_tbl+306
push rax

mov rax, qword const_tbl+289
push rax

mov rax, qword const_tbl+272
push rax

mov rax, qword const_tbl+255
push rax

mov rax, qword const_tbl+238
push rax

mov rax, qword const_tbl+221
push rax

mov rax, qword const_tbl+204
push rax

mov rax, qword const_tbl+187
push rax

mov rax, qword const_tbl+170
push rax

mov rax, qword const_tbl+153
push rax

mov rax, qword const_tbl+136
push rax
...
push 24
            ...
            mov rcx,[rbp+WORD_SIZE*3] ;;rcx=n 
            sub rcx, 3 ;;rcx=n-(length of args)      
            dec rcx
            cmp rcx,0
