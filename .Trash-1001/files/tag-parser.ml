...
| ScmPair(ScmSymbol("quasiquote"),ScmPair(ScmNil,ScmNil))-> ScmNil
...
and quote_parse first rest=
  ...
  | ScmSymbol("unquote"),ScmPair(a,ScmNil) -> a
  | ScmPair(ScmSymbol("unquote"),ScmPair(a,ScmNil)),ScmNil->list_to_proper_list [ScmSymbol("cons");a;ScmNil]
  | ScmPair(ScmSymbol("unquote"),ScmPair(a,ScmNil)),ScmPair(x,y)-> list_to_proper_list [ScmSymbol("cons"); a; (quote_parse x y)]
  | ScmPair(ScmSymbol("unquote-splicing"),ScmPair(a,ScmNil)),ScmNil-> list_to_proper_list [ScmSymbol("append"); a; ScmNil]
  | ScmPair(ScmSymbol("unquote-splicing"),ScmPair(a,ScmNil)),ScmPair(x,y)-> list_to_proper_list [ScmSymbol("append"); a; (quote_parse x y)]
  | ScmSymbol(x),ScmNil-> list_to_proper_list [ScmSymbol("cons");ScmPair(ScmSymbol("quote"),ScmPair(first,ScmNil)); ScmNil]
  | ScmSymbol(x),ScmPair(y,z)-> list_to_proper_list [ScmSymbol("cons"); ScmPair(ScmSymbol("quote"),ScmPair(first,ScmNil)); (quote_parse y z)]
  | ScmPair(x,y),ScmNil -> list_to_proper_list [ScmSymbol("cons"); (quote_parse x y);ScmNil]
  | ScmPair(x,y),ScmPair(a,b) -> list_to_proper_list [ScmSymbol("cons"); (quote_parse x y);(quote_parse a b)]
  | x,ScmNil ->list_to_proper_list [ScmSymbol("cons");first; ScmNil]
  | x,ScmPair(y,z) ->list_to_proper_list [ScmSymbol("cons");first; quote_parse y z]
