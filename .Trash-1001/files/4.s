...
MAKE_FRAME_LAMBDA_SIMPLE 2
            ...
            MAKE_CLOSURE(rax,rdx,code7)          ;; lambda
            ...
            sub rcx, 1 ;;rcx=n-(length of args)      ;;len
            dec rcx
            cmp rcx,0
...
push qword 6
            ...
            MAKE_CLOSURE(rax,rdx,code17)          ;; lambda
            ...
            mov rcx,[rbp+WORD_SIZE*3] ;;rcx=n 
            sub rcx, 2 ;;rcx=n-(length of args)      ;;len
            dec rcx
            cmp rcx,0
...
push qword 4
            ...
            MAKE_CLOSURE(rax,rdx,code21)          ;; lambda
            ...
            mov rcx,[rbp+WORD_SIZE*3] ;;rcx=n 
            sub rcx, 0 ;;rcx=n-(length of args)      ;;len
            dec rcx
            cmp rcx,0
...
MAKE_FRAME_LAMBDA_SIMPLE 0
            ...
            MAKE_CLOSURE(rax,rdx,code24)          ;; lambda
